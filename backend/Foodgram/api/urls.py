...
from .views import (CustomUserViewSet, IngridientsListViewSet,
                    IngridientsViewSet, RecieptsViewSet, TagsViewSet)
...
router.register(
    'ingredientslist', IngridientsListViewSet, basename='ingredientslist')
